			...
			<div id="main">
				...
				<center>
					<table width="510" >
						...
						<tr><th>NEW</th></tr>
						<tr><td><a href="guitarsection.php?category=New&sub1=submit"><center><img src="newg.jpg" width="450" height="175"></center></a><br></td></tr>
						<tr><th>USED</th></tr>
						<tr><td><a href="guitarsection.php?category=Used&sub1=submit"><center><img src="usedg.jpg" width="450" height="175"></center></a><br></td>
						<tr><th>VINTAGE</th></tr>
						<tr><td><a href="guitarsection.php?category=Vintage&sub1=submit"><center><img src="vintageg.jpg" width="450" height="175"></center></a></td></tr>
					     <tr height="100"><td>
						 We Present one of the Best collection of Guitars Ranging From New , Used to the Classy Vintage.
						 Choose A Category..!!
						 </td></tr>
					</table>
				</center><br>
				...
				<div id="side2" class="fl">
				      <div id="joinus"><a href="register.php"><center><br>Join Us</center></a></div>
						 ...
						 <br><br><center><font size="4" color="#f5f0ec">Login</font></center>
								<form name="form1" action="guitar.php" method="post">
		...
		else
		{
			...
			if($result)
			{
				...
				if($row[0]==$pass)
				{
					$_SESSION['name']='user';
					$_SESSION['id']=$email;
					header('Location: guitar1.php');	
				}	
				else
				header('Location:guitar.php');
			}
			else
			header('Location:guitar.php');
		}
