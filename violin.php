			...
			<div id="main">
				...
				<center>
					<table width="510" >
						...
						<tr><th>NEW</th></tr>
						<tr><td><a href="violinsection.php?category=New&sub1=submit"><center><img src="newv.jpg" width="400" height="200"></center></a><br></td></tr>
						<tr><th>USED</th></tr>
						<tr><td><a href="violinsection.php?category=Used&sub1=submit"><center><img src="usedv.jpg" width="400" height="200"></center></a><br></td>
						<tr><th>VINTAGE</th></tr>
						<tr><td><a href="violinsection.php?category=Vintage&sub1=submit"><center><img src="vintagev.jpg" width="400" height="200"></center></a></td></tr>
					     <tr height="100"><td>
						 We Present one of the Best collection of Violins Ranging From New , Used to the Classy Vintage.
						 Choose A Category..!!
						 </td></tr>
					</table>
				</center><br>
				...
				<div id="side2" class="fl">
				      <div id="joinus"><a href="register.php"><center><br>Join Us</center></a></div>
						 ...
						 <br><br><center><font size="4" color="#f5f0ec">Login</font></center>
								<form name="form1" action="violin.php" method="post">
