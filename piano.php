			...
			<div id="main">
				...
				<center>
					<table width="510" >
						...
						<tr><th>NEW</th></tr>
						<tr><td><a href="pianosection.php?category=New&sub1=submit"><center><img src="newp.jpg" width="400" height="200"></center></a><br></td></tr>
						<tr><th>USED</th></tr>
						<tr><td><a href="pianosection.php?category=Used&sub1=submit"><center><img src="usedp.jpg" width="400" height="200"></center></a><br></td>
						<tr><th>VINTAGE</th></tr>
						<tr><td><a href="pianosection.php?category=Vintage&sub1=submit"><center><img src="vintagep.jpg" width="400" height="200"></center></a></td></tr>
					     <tr height="100"><td>
						 We Present one of the Best collection of Pianos Ranging From New , Used to the Classy Vintage.
						 Choose A Category..!!
						 </td></tr>
					</table>
				</center><br>
				...
				<div id="side2" class="fl">
				      <div id="joinus"><a href="register.php"><center><br>Join Us</center></a></div>
						 ...
						 <br><br><center><font size="4" color="#f5f0ec">Login</font></center>
								<form name="form1" action="piano.php" method="post">
