...
<center>
	...
	<tr><td>
	<b>
	Pincode :</td><td><input type="text" name="pincode" size="20">
    </b></td></tr>
	<tr><td>
	<b>
	Interests :</td><td><textarea name="interest" rows="3" cols="20"></textarea>
    </b></td></tr>
	</table>
...
else 
{
	...
	$email=$_POST['email'];
	$info=$_POST['interest'];
	$query="insert into user values('$name','$pass','$address','$city','$gender',$phone,'$email',$pincode,2,'$info')";
