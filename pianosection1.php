			...
			<div id="main">
				<div id="display" class="fl">
						...
						$category=$_GET['category'];
							...
							{
								$name=strtok($row[0]," ");
								echo '<tr><td><br><a href="booking1.php?name='.$row[0].'&id='.$row[1].'&tn=piano&sub1=submit"><img src="instrument/piano/'.$category.'/'.$name.'.jpg" width="300" height="180"></a></td><td>'.$row[0].'<br>Price: Rs '.$row[3].'</td></tr>';
							}
							echo '</table></div><hr>';		
						?>
				</div>
